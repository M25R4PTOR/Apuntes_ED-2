...
- La compilación/interpretación del código fuente se lleva a cabo en dos fases:
  1. __Análisis léxico__ (Vocabulario)
  2. __Análisis sintáctico__ (Gramática)
...
- Desventajas:
  - Menos eficiente que los lenguajes compilados (ejecución más lenta)


### Tipos (I)

- Según la forma en la que operan:
  - __Declarativos__: indicamos el resultado a obtener sin especificar los pasos. (consulta SQL)
  - __Imperativos__: indicamos los pasos a seguir para obtener un resultado. (programa Java)
...
Se utilizan poco en la actualidad salvo SQL.
...
(Número de instrucciones para realizar una operación)
...
- Campo de aplicación (Tipo de programa)
- Experiencia previa
